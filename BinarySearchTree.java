...
public class BinarySearchTree{
  ...
  public static void main(String[] args){
    ...
    // bst.insert(x);
    // bst.insert(new Student("Zak", "Moulay", "I12345"));
    // bst.insert(new Student("Ziedine", "Zidane", "Z12345"));
    // bst.insert(new Student("Lori", "Hernandez", "H12345"));
    // bst.insert(new Student("Robeerto", "Carrlos", "D12335"));
    // bst.insert(new Student("Neymard", "DfaSilva", "D22345"));
    // bst.insert(new Student("Messi", "DaSifva", "D16345"));
    // bst.insert(new Student("Neymar", "DaSilva", "D12395"));
    // bst.insert(new Student("Ashraf", "Hakimi", "D10345"));
